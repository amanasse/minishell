...
- chevron (suivi forcement d un file)
	...
	◦ << doit recevoir un délimiteur et lire l input donné jusqu à rencontrer une ligne	contenant le délimiteur. 
...
c) construire tableau de commandes en ayant modifier les maillons de la liste
